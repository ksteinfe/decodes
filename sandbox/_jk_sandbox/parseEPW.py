...
def parse_epw_file(path, skip, desired_keys):
...
filepath = "./USA_CA_San.Francisco.Intl.AP.724940_TMY3.epw"
...
hours = parse_epw_file(filepath, number_of_header_lines, keys)
