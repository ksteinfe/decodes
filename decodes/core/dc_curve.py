...
class Curve(HasBasis,IsParametrized):
    ...
    @property
    def tol(self): 
        #TODO: express tolerence as a percentage of domain delta instead... surfaces may have radically different domains in either direction
