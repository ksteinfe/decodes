...
namespace GhPython.Component
{
  public abstract class ScriptingAncestorComponent : SafeComponent
  {
    ...
    const string DESCRIPTION = "A python scriptable component that implements the Decodes library";
    ...
    protected override void SafeSolveInstance(IGH_DataAccess DA)
    {
      ...
      try
      {
        ...
        {
          m_py_output.Write("There was a permanent error parsing this script. Please report to ksteinfe@gmail.com.");
        }
      }
      catch (Exception ex)
      {
          ...
          var tsi = new ToolStripMenuItem("&Presentation style", null, new ToolStripItem[]
            {
              ...
              new ToolStripMenuItem("Show output \"console\" parameter", GetCheckedImage(!HideCodeOutput),
                                    new TargetGroupToggler
                                      {
                                        Component = this,
