...
class LinearEntity(fp.Geometry):
    ...
    def __init__(self, a, b):
      self._pt = a if isinstance(a,fp.Point) else Point(a.x,a.y,a.z)
      if isinstance(b,fp.Vec) : self._vec = b
      elif isinstance(b,fp.Point) : self._vec = b-a
