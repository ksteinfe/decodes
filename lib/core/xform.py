...
if fp.VERBOSE_FS: print "xform.py loaded"
...
class Xform(object):
  ...
  def __mul__(self, other):
    ...
    This function must be kept up to date with every new class of FP geom
    '''
